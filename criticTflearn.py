# Taken from http://pemami4911.github.io/blog/2016/08/21/ddpg-rl.html
...
class Critic(object):
    ...
    def create_critic_network(self):
        ...
        t1 = tflearn.fully_connected(net, 300, weights_init=w_init_hidden)
        t2 = tflearn.fully_connected(action, 300, weights_init=w_init_hidden)
